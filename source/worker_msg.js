...
const MSGID_SPRITE_SHEET_REQUEST_RESULT = 7;
...
const MSGID_GET_IMAGE_WIDTH_REQUEST = 20;
const MSGID_GET_IMAGE_HEIGHT_REQUEST = 21;
const MSGID_ENABLE_CANVAS_BUFFER = 22;
const MSGID_DISABLE_CANVAS_BUFFER = 23;
const MSGID_DRAW_CANVAS_BUFFER = 24;
const MSGID_ADD_CANVAS_EVENT = 25;
const MSGID_REMOVE_CANVAS_EVENT = 26;
const MSGID_DRAW_TEXT = 27;
const MSGID_DRAW_RECT = 28;
const MSGID_DRAW_CIRCLE = 29;
const MSGID_DRAW_LINE = 30;
const MSGID_SET_TEXT_FONT = 31;
const MSGID_SET_FILL_COLOR = 32;
const MSGID_SET_LINE_COLOR = 33;
const MSGID_SET_LINE_SIZE = 34;
...
const MSGID_LOAD_SPRITE_SHEET_REQUEST = 70;
const MSGID_UNLOAD_SPRITE_SHEET_REQUEST = 71;
const MSGID_DRAW_SPRITE_SHEET_FRAMES_REQUEST = 72;
const MSGID_GET_SPRITE_SHEET_FRAME_WIDTH_REQUEST = 73;
const MSGID_GET_SPRITE_SHEET_FRAME_HEIGHT_REQUEST = 74;