...
const versionHTML = `<div id="version">Version 2.0.2.13 - <a href="../updates.html" target="_blank">Updates</a></div>`;
...
//
{
  ...
  initDebugUI(mainDiv, "beforebegin");
  initEditorUI(mainDiv, "beforeend", paramFileURL);
  mainDiv.insertAdjacentHTML("beforeend", statusBarHTML);
  initConsoleUI(mainDiv, "beforeend");
  initCanvasUI(mainDiv, "beforeend");
  ...
  toggles = document.getElementsByClassName("toggle-open");
